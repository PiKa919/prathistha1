...
export default function Component() {
  ...
  const slides = [
    {
    //   image: "/assets/images/scroller1.svg?height=600&width=1600",
      image: "/assets/images/scroller1.jpg",
      alt: "Summer Sale",
      title: "Summer Sale",
                ...
                <Card key={category}>
                  <CardContent className="p-4">
                    <img
                      ...
                      height="160"
                      src={`/assets/images/scroller1.jpg?height=160&width=320`}
                      style={{
                        aspectRatio: "320/160",
                        objectFit: "cover",
                      }}
                ...
                <Card key={product}>
                  <CardContent className="p-4">
                    <img
                      ...
                      height="192"
                      src={`/assets/images/scroller1.jpg?height=192&width=256`}
                      style={{
                        aspectRatio: "256/192",
                        objectFit: "cover",
                      }}
