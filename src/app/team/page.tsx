...
const teamsData = {
  ...
  lr: [
    {
      ...
      about:
        "Chaos coordinator with a talent for making life an unpredictable adventure, fueled by caffeine and curiosity! ",
  ...
  sponsorship: [
    {
      ...
      image: "/team/sponsorship/viplav.webp",
      about:
        "Trailblazing second-year Sponsorship Secretary, securing partnerships, inspiring peers, and leaving a lasting legacy.",
      instagram: "viplaavv",
  ...
  sports: [
    ...
    },
    {
      ...
      subheading: "Sports Secretary",
      image: "/team/sports/sanika.webp",
      about:
        "I'm a  volleyball player who spikes on the court and panics off it. A topper who’s always late but somehow always on point. Chaos might follow me, but I still ace it every time!",
    ...
    },
    {
      ...
      image: "/team/sports/vedantgharat.webp",
  ...
  technical: [
    ...
    },
    {
      ...
      about:
        "A dedicated Technical Coordinator ensuring efficient workflows, team collaboration, and successful project outcomes.",
  ...
  treasurer: [
    {
      ...
      about:
        "Managing the budget is a challenge, especially with everyone treating money as if it's just paper growing on trees.",
      instagram: "_14yash_",
...
const HeadsSection = ({ data }: { data: TeamMember[] }) => (
  <div className="mb-16" id="heads">
    <h2 className="text-4xl font-bold text-white text-center mb-10">Festival Heads</h2>
