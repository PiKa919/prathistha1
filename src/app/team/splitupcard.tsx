...
export default function Page() {
  ...
  const topContent = (
    <div className="bg-zinc-900/90 rounded-md text-gray-100 shadow-[0px_1px_1px_0px_rgba(255,255,255,0.05),0px_1px_1px_0px_rgba(255,255,255,0.1)_inset,0px_0px_0px_1px_hsla(0,0%,100%,0.05)_inset,0px_0px_1px_0px_rgba(255,255,255,0.1)] dark:shadow-[0_1px_0_0_rgba(255,255,255,0.05)_inset,0_0_0_1px_rgba(255,255,255,0.05)_inset]">
  ...
  const topAnimateContent = (
    <>
      <motion.img
        ...
        height={100}
        alt="basic image"
        className="rounded-sm absolute top-1.5 right-2 shadow-[0_2px_8px_rgba(255,255,255,0.1)]"
      />

      <motion.div
        className="h-[70px] w-[82px] absolute top-[4px] right-[6px] bg-transparent border-[2px] rounded-br-sm rounded-sm border-gray-300/20 border-dashed ml-auto mb-[6px]"
  ...
  const middleContent = (
    <motion.img
      ...
      height={200}
      alt="basic image"
      className="rounded-sm border-2 border-gray-700"
    />
  )
  ...
  const bottomContent = (
    <div className="absolute bottom-0 left-0 right-0">
      <div className="flex w-full flex-col gap-0.5 bg-zinc-900/95 border-t border-t-white/10 rounded-t-lg px-3 pb-1.5 align-bottom">
        <div className="font-sans text-[14px] font-medium text-gray-100 flex gap-1 pt-1.5 items-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="w-full text-pretty font-sans text-[13px] leading-4 text-gray-300">
        ...
        <div className="bg-zinc-800/90 px-1 py-0.5 rounded-xl flex flex-row gap-1 justify-between mt-1 mb-1">
          <TextureButton variant="primary" className="hover:bg-zinc-700/80 text-gray-100 flex-1 text-sm">
            <svg
              viewBox="0 0 256 209"
              width="1em"
              height="1em"
  ...
  return (
    <main className="flex min-h-screen justify-center items-center bg-zinc-950">
      <ShiftCard
