    ...
    <td className="border border-gray-600 px-2 md:px-4 py-1 md:py-2">34</td>
            ...
            {!allLinksClicked() && (
             ...
             <Button 
              type="submit" 
              disabled={true}
              className={`w-full bg-gradient-to-r from-gray-600 to-gray-700 text-gray-300 cursor-not-allowed text-base md:text-lg py-3 md:py-4 rounded-xl font-semibold transition-all duration-300`}
            >
              Registration Closed
            </Button> 
          </form>
