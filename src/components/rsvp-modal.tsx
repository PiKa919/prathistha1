  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button 
          className="bg-[#CBA35C] text-[#754E1A] hover:bg-[#F8E1B7] rounded-full scale-125"
        >
          RSVP Now
        </Button>
      </DialogTrigger>
        ...
        <div className="grid gap-4 py-4">
          {submitted ? (
            ...
            <>
              ...
              <div className="text-[#754E1A] font-semibold">
                Rude Lounge
              </div>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button 
                  type="submit" 
                  className="w-full bg-[#CBA35C] text-[#754E1A] hover:bg-[#F8E1B7]"
